...
Outside collaborators will need to [get NTP status](https://forum.arcus.chop.edu/t/can-someone-from-outside-of-chop-be-a-collaborator-in-an-arcus-lab/779) with CHOP in order to access Arcus tools, including your lab. However, you **can** start the request for your Arcus Lab before all of the non-CHOP workforce members of your team have obtained NTP status! Just keep in mind that any delays in the NTP process may delay delivery of your Arcus Lab. Be sure to advise your collaborator to check both the email they provide to get NTP status **and** their new CHOP email for updates.
...
[Schedule office hours or a lab walkthrough with Arcus Data Education](https://outlook.office365.com/book/BKG-StandardArcusEducationOfficeHours@chop.edu/), where you can talk with an Arcus Data Science Educator about your specific questions.

### Arcus On-Ramp

The [Arcus On-Ramp](https://wd108.myworkday.com/chop/email-universal/inst/23455$3802/rel-task/2998$35805.htmld) is a series of webinars featuring hands-on practice with real data in an Arcus lab. 
If you're new to Arcus, these videos are a great way to get up to speed using the tools and data in an Arcus Lab in ways that you'll use them in your own research. 

The notebooks we use for the On-Ramp series are also available in all Arcus labs as well as on [GitHub](https://github.research.chop.edu/arcus/notebooks/tree/main/arcus_on_ramp) (you'll need to be on CHOP's network to access them), so you can work through that content on your own and/or return to review it after completing the series in Workday.
