...
![Graphic representation of the lifecycle of research data in Arcus](media/data_life_cycle.png)<!-- style = "border: 1px solid rgb(var(--color-highlight)); max-width: 1000px; float: left; margin-right: 2rem; margin-bottom: 2rem;"-->
