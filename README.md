...
- Who builds it?
- Running costs (e.g. why your lab times out)
...
- os, session
- bug, issue, repo, repex, foo, df
- error, warning, message
- dataset, table, query, key, operator
- backticks, single quote, double quote, regex
- object, function, method, environment, directory, path
- download, install, import, package, module, library
- data science glossary (expand/revise/curate https://education.arcus.chop.edu/glossary/?)

# New to version control/git?
...
# Arcus Applied: Researchers speak on their experience with Arcus Labs
Example questions:
- What drew you to Arcus?
- What was your path to data science?
- What is your team like? How do you collaborate?
- What tools do you use most in your Arucs Lab?
- What roadblocks did you hit? What parts took longer than expected?
- What do you wish you had known when you first started your Arcus Lab?
- What advice would you give someone with a similar background to yours who is considering starting an Arcus Lab?
- Tour of your lab!
