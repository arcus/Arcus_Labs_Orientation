...
- Pt was brought in by neighbor, **Zahir**, who found him collapsed in backyard.
- Dear Mr. **Tsui**, I am writing to follow up on your child's recent appointment at our clinic. 
- Mom reports that pt's younger sister, **Rae**, has had similar sx.
...
For example, "Pt loves **Peppa Pig**, it helps to play that when you need to adjust his dressing" should have the label NAMES on the span "Peppa Pig" but it should also be checked as "NonIdentifying". 
...
- Enrolled in the program from **4-8y**
...
- Abbott Elementary, Student ID **123999**
...
- His aunt is the **first recipient of the Nobel Peace Prize** in this decade.
- 
